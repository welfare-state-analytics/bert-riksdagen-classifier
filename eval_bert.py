...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="data/training_data.csv", help="Testing data as a .CSV file. Needs to have 'content' (X) and 'tag' (Y) columns.")
